...
namespace Fusion.Addons.ConnectionManagerAddon
{
    ...
    public class ConnectionManager : MonoBehaviour, INetworkRunnerCallbacks
    {
        ...
        public NetworkObject userPrefabVR;
        public NetworkObject userPrefabPC;

        public Transform spawnPointVR;
        public Transform spawnPointPC;
        ...
        public void OnPlayerJoinedSharedMode(NetworkRunner runner, PlayerRef player)
        {
            if(spawnVR){
                if (player == runner.LocalPlayer && userPrefabVR != null)
                {
                    ...
                    runner.MakeDontDestroyOnLoad(networkPlayerObject.gameObject);
                }
            } else {
    ...
    /*
        ...
        */
        ...
        public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
        {
            ...
            {
                Debug.Log("OnPlayerJoinedHostMode not implemented");
